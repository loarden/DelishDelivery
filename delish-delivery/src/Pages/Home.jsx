...
function Home() {
  return (
    <main className="hero-banner flex justify-center items-center text-white bg-cover bg-center relative z-0 bg-black w-full min-h-screen h-fit before:top-0 before:left-0 before:absolute before:w-full before:h-full before:backdrop-brightness-50 ">
